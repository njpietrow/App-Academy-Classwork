...
describe "Phase 1:" do
    ...
    describe "rampant_repeats" do
        ...
        it "should return a new string where characters of the original string are repeated the number of times specified by the hash. if not in hash, don't change" do
