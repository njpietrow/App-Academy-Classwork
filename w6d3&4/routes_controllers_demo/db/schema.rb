...
ActiveRecord::Schema.define(version: 2022_02_03_201209) do
  ...
  create_table "comments", force: :cascade do |t|
    ...
    t.integer "commented_artwork_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["commented_artwork_id"], name: "index_comments_on_commented_artwork_id"
